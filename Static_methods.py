class student:    #classes
    ...
    @staticmethod
    def printer(string):
        print(f"you have just used static method to print {string}")
...
student.printer("i am learning OOPs.")
vishal.printer("i am acessing it through objects. its soo cool.")
